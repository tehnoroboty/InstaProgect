...
import { MenuItemsType } from '@/src/components/navigationPanel/NavigationPanel'
import { MenuSection } from '@/src/components/navigationPanel/sidebar/menuSection/MenuSection'
