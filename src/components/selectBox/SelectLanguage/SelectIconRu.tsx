...
export const SelectIconRu = ({ className }: Props) => {
  return (
    <svg
      width="20"
      height="20"
      ...
      className={className}
    >
      <rect width="20" height="20" fill="url(#pattern0_10351_15141)" />
      <defs>
        <pattern
          id="pattern0_10351_15141"
          patternContentUnits="objectBoundingBox"
          width="1"
          height="1"
        >
          <use xlinkHref="#image0_10351_15141" transform="scale(0.0138889)" />
        </pattern>
        <image
          id="image0_10351_15141"
          width="72"
          height="72"
