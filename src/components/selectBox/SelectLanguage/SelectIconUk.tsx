...
export const SelectIconUk = ({ className }: Props) => {
  return (
    ...
    >
      <rect fill={'url(#pattern0_25086_11601)'} height={'20'} width={'20'} />
      <defs>
        <pattern
          height={'1'}
          id={'pattern0_25086_11601'}
          patternContentUnits={'objectBoundingBox'}
          width={'1'}
        >
          <use transform={'scale(0.0138889)'} xlinkHref={'#image0_25086_11601'} />
        </pattern>
        <image
          height={'72'}
          id={'image0_25086_11601'}
          width={'72'}
          xlinkHref={
